   ...
   * http://localhost:8080/DemoService/DemoService.svc/Categories(3)/Products
    ...
    public void readEntityCollection(ODataRequest request, ODataResponse response,
        ...
        if (segmentCount == 1) { // this is the case for: DemoService/DemoService.svc/Categories
            System.out.println("READ COLLECTION SEGMENT=1");
            ...
            System.out.println("READ COLLECTION SEGMENT=2");
            ...
            if (lastSegment instanceof UriResourceNavigation) {
                ...
                System.out.println(sourceEntity.getType());
        ...
        LinkedList<Entity> resultingSet = new LinkedList<>(entityList);
        //clear the previous list (results from the database) and create new modified list.
        responseEntityCollection.getEntities().clear();
        for (Entity entity : resultingSet) {
        ...
        EntityCollectionSerializerOptions opts = EntityCollectionSerializerOptions.with().contextURL(contextUrl).id(id).count(countOption).build();
